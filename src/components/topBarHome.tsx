    ...
    return (
        <header className="bg-red-50 text-[#046C5E] flex justify-between items-center px-6 py-4 shadow" >
            ...
            <nav className="flex gap-4 text-sm items-center">
                <a href="/register" className="hover:underline">Criar perfil</a>
                <a href="/login" className="hover:underline">Entrar</a>
                <a href="#" className="bg-[#046C5E] text-white px-4 py-2 rounded-full hover:bg-[#03584d]">Trabalhe conosco</a>
            </nav>
        </header >
    );
}